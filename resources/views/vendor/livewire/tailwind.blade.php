...
<div>
    @if ($paginator->hasPages())
        <nav role="navigation" aria-label="Pagination Navigation"
            class="flex flex-col gap-y-2 items-center justify-between">
            ...
            <div
                class="sm:flex-1 sm:flex sm:flex-col xl:flex-row sm:gap-y-2 sm:gap-x-4 sm:items-center sm:justify-between">
                {{-- Showing --}}
                <div class="">
                    <p class="text-sm text-gray-700 leading-5 dark:text-gray-400">
                        <span>{!! trans_choice('words.s.showing', 1) !!}</span>
                        <span class="font-medium">{{ $paginator->firstItem() }}</span>
                        <span>{!! \Str::lower(trans_choice('words.t.to', 2)) !!}</span>
                        <span class="font-medium">{{ $paginator->lastItem() }}</span>
                        <span>{!! \Str::lower(trans_choice('words.o.of', 1)) !!}</span>
                        <span class="font-medium">{{ $paginator->total() }}</span>
                        <span>{!! \Str::lower(trans_choice('words.r.result', 2)) !!}</span>
                    </p>
                </div>
